      ...
      ${this._scheduleDays.map(((e,t)=>o.dy`
          <tr class="mdc-data-table__row">
            ...
            <td class="mdc-data-table__cell whitespace-pre-line" scope="row">
              ${(0,A._)(e.endDate,{dateStyle:"medium"})}
            </td>
