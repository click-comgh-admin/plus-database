      ...
      <tr class="mdc-data-table__row">
        <th class="mdc-data-table__cell" scope="row">
          <div class="flex items-start flex-col">
            ...
            <p>From: ${a} - To: ${r} </p>
            <hr class="my-1"/>
            <small>${e.isRecuring?(0,I.C)(this.getAttendanceScheduleDay(t),i.dy`<span>Loading...</span>`):(0,I.C)(this.getAttendanceScheduleDate(t),i.dy`<span>Loading...</span>`)}</small>
          </div>
        </th>
