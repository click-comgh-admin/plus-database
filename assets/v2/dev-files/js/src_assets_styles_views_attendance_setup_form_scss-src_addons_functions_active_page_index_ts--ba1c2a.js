...
(self.webpackChunkwebpackNumbers = self.webpackChunkwebpackNumbers || []).push([
    ["src_assets_styles_views_attendance_setup_form_scss-src_addons_functions_active_page_index_ts--ba1c2a"], {
        9579: (t, e, n) => { n.r(e) },
        8485: (t, e, n) => {
        ...
        577: (t, e, n) => {
            let o, i, s, a, c, r, u, d, l;
            if (n.r(e), n.d(e, { URLS: () => _ }), n(4510).APP_SETTINGS.production) {
                const t = "akwaabaapp.com/";
                i = "https://api.akwaabaapp.com/", s = "https://api." + t, d = "akwaabaclients." + t, o = "https://" + d, r = "https://akwaabaapp." + t, a = "https://file-bucket.akwaabasoftware.com/", c = o + "", u = r + "", l = "https://database.akwaabasoftware.com/"
            } else {
                d = "akwaaba-forms/";
                const t = "192.168.173.1";
                o = "http://127.0.0.1:9001/", i = "http://" + t + "/AMG/plus_db/api/", s = o + "api/", l = "http://" + t + "/AMG/plus_db/client_dashboard/", a = "http://" + t + "/AMG/plus_db/file_bucket/", c = o + d, u = o + "akwaaba-forms-public/"
            }
            const _ = { BASE_URL: o, API_BASE_URL: i, PDB_CLIENT: l, AKWAABA_API_BASE_URL: s, FILE_BUCKET_BASE_URL: a, HOME_PAGE_BASE_URL: c, PUBLIC_PAGE_BASE_URL: u, LOGIN_PAGE_BASE_URL: void 0, PUBLIC_LOGIN_PAGE_BASE_URL: void 0, PUBLIC_BASE_URL: "https://akwaabaapp.com/", CLICK_COM_BASE_URL: "https://clickcomgh.com/" }
        },
        3750: (t, e, n) => {
        ...
        4108: (t, e, n) => {
            ...
            const r = (t, e, n) => c(void 0, void 0, void 0, (function*() {
                    ...
                    if ((t => { const e = new Date; return Math.abs(t.getTime() - e.getTime()) / 36e5 < 24 })(new Date((0, a.get_cookie)(d + "_date")))) return l;
                    yield(0, i.http)(r, { method: "POST", body: _ }, !0).then((o => c(void 0, void 0, void 0, (function*() {
