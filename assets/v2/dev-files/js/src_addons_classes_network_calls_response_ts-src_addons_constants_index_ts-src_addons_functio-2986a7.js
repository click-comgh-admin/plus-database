...
(self.webpackChunkwebpackNumbers = self.webpackChunkwebpackNumbers || []).push([
    ["src_addons_classes_network_calls_response_ts-src_addons_constants_index_ts-src_addons_functio-2986a7"], {
        4492: (e, t, s) => {
            s.r(t), s.d(t, { NetWorkCallResponses: () => n });
            var r = s(1942),
                o = s(6217);
            class n {
                constructor(e, t, s = !1, o = null) {
                    this.response = null, this.multipleResponse = null, this.paginResponse = null, this.databaseResponse = null, this.postForm = null;
                    const n = t.jsonData,
                        a = t.response;
                    if (this.postForm = o, t.response.ok) {
                        const e = String(window.supersecret.unknowable.ops.cookieName);
                        (0, r.set_cookies_minutes)(`${e}_date`, (new Date).toUTCString(), 10)
                    }
                ...
                post(e, t) {
                    ...
                    if (e.hasOwnProperty("success") && e.hasOwnProperty("message") && e.hasOwnProperty("data")) s = e;
                        ...
                        if (t.ok) {
                            ...
                            e.forEach((e => {
                                s = this.postError(e);
                                const r = this.outputErrorResponse(s.success, s.message, s.nameError, s.unknownError, s.data);
                ...
                postError(e) {
                    const t = this.postErrorFields(e),
                        ...
                        o = this.postErrorInputs(s, r);
                    return { success: !1, message: t, nameError: o.nameErrorFields, unknownError: o.nonNameErrorFields, data: e }
                }
                postErrorFields(e) {
                    let t = [];
                    for (const s in e)
                        if (Object.prototype.hasOwnProperty.call(e, s)) {
                            const r = { id: s, errors: e[s] };
                            t.includes(r) || t.push(r)
                        }
                    return t
                }
                ...
                postErrorInputs(e, t) {
                    const s = JSON.parse((0, o.formDataToJson)(new FormData(this.postForm)));
                    for (const e in s) {
                        let t;
        ...
        8485: (e, t, s) => {
            ...
            var r = s(3133),
                o = s(4510);
            const n = { URLS: s(577).URLS, APP_SETTINGS: o.APP_SETTINGS, SERVICE_WORKER_TYPES: r.SERVICE_WORKER_TYPES };
            window.CONSTANTS = n
        },
        3133: (e, t, s) => { s.r(t), s.d(t, { SERVICE_WORKER_TYPES: () => r }); const r = { postAction: "POST_ACTION", networkStatus: "NETWORK_STATUS" } },
        4510: (e, t, s) => {
            let r;
            s.r(t), s.d(t, { APP_SETTINGS: () => o }), r = !!window.location.href.includes(void 0);
            const o = { production: !1, isClientApp: r }
        },
        577: (e, t, s) => {
            let r, o, n, a, i, p, l, c, u;
            if (s.r(t), s.d(t, { URLS: () => d }), s(4510).APP_SETTINGS.production) {
                const e = "akwaabaapp.com/";
                o = "https://api.akwaabaapp.com/", n = "https://api." + e, c = "akwaabaclients." + e, r = "https://" + c, p = "https://akwaabaapp." + e, a = "https://file-bucket.akwaabasoftware.com/", i = r + "", l = p + "", u = "https://database.akwaabasoftware.com/"
            } else {
                c = "akwaaba-forms/";
                const e = "192.168.173.1";
                r = "http://127.0.0.1:9001/", o = "http://" + e + "/AMG/plus_db/api/", n = r + "api/", u = "http://" + e + "/AMG/plus_db/client_dashboard/", a = "http://" + e + "/AMG/plus_db/file_bucket/", i = r + c, l = r + "akwaaba-forms-public/"
            }
            const d = { BASE_URL: r, API_BASE_URL: o, PDB_CLIENT: u, AKWAABA_API_BASE_URL: n, FILE_BUCKET_BASE_URL: a, HOME_PAGE_BASE_URL: i, PUBLIC_PAGE_BASE_URL: l, LOGIN_PAGE_BASE_URL: void 0, PUBLIC_LOGIN_PAGE_BASE_URL: void 0, PUBLIC_BASE_URL: "https://akwaabaapp.com/", CLICK_COM_BASE_URL: "https://clickcomgh.com/" }
        },
        1942: (e, t, s) => {
            function r(e, t, s = 1) {
                let r = new Date;
                r.setHours(r.getHours() + 3 * s);
                let o = "expires=" + r.toUTCString();
                n(e) != t && (document.cookie = e + "=" + t + "; expires=expires=" + o)
            }

            function o(e, t, s = 1) {
                let r = new Date;
                r.setMinutes(r.getMinutes() + s);
                let o = "expires=" + r.toUTCString();
                n(e) != t && (document.cookie = e + "=" + t + "; expires=expires=" + o)
            }
            ...
            s.r(t), s.d(t, { set_cookies: () => r, set_cookies_minutes: () => o, get_cookie: () => n })
        },
        6217: (e, t, s) => { s.r(t), s.d(t, { formDataToJson: () => r }); const r = e => { let t = {}; return e.forEach(((e, s) => { Reflect.has(t, s) ? (Array.isArray(t[s]) || (t[s] = [t[s]]), t[s].push(e)) : t[s] = e })), JSON.stringify(t) } },
        7270: (e, t, s) => {
            s.r(t), s.d(t, { http: () => n });
            var r = s(7153),
                o = function(e, t, s, r) {
                    return new(s || (s = Promise))((function(o, n) {
                        function a(e) { try { p(r.next(e)) } catch (e) { n(e) } }

                        function i(e) { try { p(r.throw(e)) } catch (e) { n(e) } }
            ...
            function n(e, t, s = !0) {
                return o(this, void 0, void 0, (function*() {
                    ...
                    return t.mode = "cors", t.redirect = "follow", yield(0, r.default)(e, t, 3e5).then((e => (n = e, e.status >= 200 && e.status, Promise.resolve(e)))).then((e => o(this, void 0, void 0, (function*() { return { jsonData: 204 === e.status ? {} : yield e.json(), response: e, error: "" } })))).then((e => o(this, void 0, void 0, (function*() { return e })))).catch((function(e) { throw console.error("Request failed", e), e }))
                }))
            }
        },
        8967: (e, t, s) => {
            s.r(t), s.d(t, { __swalStyle: () => r, https_swal_error_format: () => o });
            const r = "<style>#swal2-validation-message{\n  display: flex !important;\n  justify-content: flex-start !important;\n  font-weight: 600 !important;\n}#swal2-validation-message>ul{list-style: inside !important; margin: 0 !important;}</style>",
                o = (e, t = !0) => { if (Array.isArray(e)) { let s = (t ? r : "") + "<ul>"; return e.forEach((e => { s += "string" == typeof e ? `<li>${e}</li>\n` : `<li>${e.error}</li>\n` })), s += "</ul>" } throw new Error("Unknown error response format") }
        },
        7153: (e, t, s) => {
            s.r(t), s.d(t, { default: () => r });

            function r(e, t, s = 7e3) {
                return r = this, o = void 0, a = function*() { return Promise.race([fetch(e, t), new Promise(((e, t) => { setTimeout((() => t(new Error("Connection timeout, check network for internet access"))), s) }))]) }, new((n = void 0) || (n = Promise))((function(e, t) {
...
//# sourceMappingURL=src_addons_classes_network_calls_response_ts-src_addons_constants_index_ts-src_addons_functio-2986a7.js.map