...
(self.webpackChunkwebpackNumbers = self.webpackChunkwebpackNumbers || []).push([
    ["src_addons_classes_network_calls_response_ts-src_addons_constants_index_ts-src_addons_functio-2986a7"], { 4492: (e, t, s) => { s.r(t), s.d(t, { NetWorkCallResponses: () => n }); var r = s(1942),
                o = s(6217);
            class n { constructor(e, t, s = !1, o = null) { this.response = null, this.multipleResponse = null, this.paginResponse = null, this.databaseResponse = null, this.postForm = null; const n = t.jsonData,
                        a = t.response; if (this.postForm = o, t.response.ok) { const e = String(window.supersecret.unknowable.ops.cookieName);
            ...
            s.r(t), s.d(t, { APP_SETTINGS: () => o }), r = !!window.location.href.includes(void 0); const o = { production: !1, isClientApp: r } }, 577: (e, t, s) => { let r, o, n, a, i, p, l, c, u; if (s.r(t), s.d(t, { URLS: () => d }), s(4510).APP_SETTINGS.production) { const e = "akwaabaapp.com/";
                o = "https://api.akwaabaapp.com/", n = "https://api." + e, c = "akwaabaclients." + e, r = "https://" + c, p = "https://akwaabaapp." + e, a = "https://file-bucket.plusdatabase.com/", i = r + "", l = p + "", u = "https://database.akwaabasoftware.com/" } else { c = "akwaaba-forms/"; const e = "192.168.173.1";
                r = "http://127.0.0.1:9001/", o = "http://" + e + "/AMG/plus_db/api/", n = r + "api/", u = "http://" + e + "/AMG/plus_db/client_dashboard/", a = "http://" + e + "/AMG/plus_db/file_bucket/", i = r + c, l = r + "akwaaba-forms-public/" } const d = { BASE_URL: r, API_BASE_URL: o, PDB_CLIENT: u, AKWAABA_API_BASE_URL: n, FILE_BUCKET_BASE_URL: a, HOME_PAGE_BASE_URL: i, PUBLIC_PAGE_BASE_URL: l, LOGIN_PAGE_BASE_URL: void 0, PUBLIC_LOGIN_PAGE_BASE_URL: void 0, PUBLIC_BASE_URL: "https://akwaabaapp.com/", CLICK_COM_BASE_URL: "https://clickcomgh.com/" } }, 1942: (e, t, s) => {
            function r(e, t, s = 1) { let r = new Date;
                r.setHours(r.getHours() + 3 * s); let o = "expires=" + r.toUTCString();
                n(e) != t && (document.cookie = e + "=" + t + "; expires=expires=" + o) }

            function o(e, t, s = 1) { let r = new Date;
                r.setMinutes(r.getMinutes() + s); let o = "expires=" + r.toUTCString();
                n(e) != t && (document.cookie = e + "=" + t + "; expires=expires=" + o) }
            ...
            function r(e, t, s = 7e3) { return r = this, o = void 0, a = function*() { return Promise.race([fetch(e, t), new Promise(((e, t) => { setTimeout((() => t(new Error("Connection timeout, check network for internet access"))), s) }))]) }, new((n = void 0) || (n = Promise))((function(e, t) {
                    ...
                    p((a = a.apply(r, o || [])).next()) })); var r, o, n, a } } }
]);
