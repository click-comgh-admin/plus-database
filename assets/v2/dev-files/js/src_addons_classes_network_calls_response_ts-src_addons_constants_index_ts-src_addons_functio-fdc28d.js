...
(self.webpackChunkwebpackNumbers = self.webpackChunkwebpackNumbers || []).push([
    ["src_addons_classes_network_calls_response_ts-src_addons_constants_index_ts-src_addons_functio-fdc28d"], {
        4492: (e, t, s) => {
            ...
            class n {
                constructor(e, t, s = !1, o = null) {
                    ...
                    const n = t.jsonData,
                        a = t.response;
                    if (this.postForm = o, t.response.ok) try {
        ...
        577: (e, t, s) => {
            let r, o, n, a, i, c, p, u, l;
            if (s.r(t), s.d(t, { URLS: () => d }), s(4510).APP_SETTINGS.production) {
                const e = "akwaabaapp.com/";
                o = "https://api.akwaabaapp.com/", n = "https://api." + e, u = "akwaabaclients." + e, r = "https://" + u, c = "https://akwaabaapp." + e, a = "https://file-bucket.akwaabasoftware.com/", i = r + "", p = c + "", l = "https://database.akwaabasoftware.com/"
            } else {
                u = "akwaaba-forms/";
                const e = "192.168.173.1";
                r = "http://127.0.0.1:9001/", o = "http://" + e + "/AMG/plus_db/api/", n = r + "api/", l = "http://" + e + "/AMG/plus_db/client_dashboard/", a = "http://" + e + "/AMG/plus_db/file_bucket/", i = r + u, p = r + "akwaaba-forms-public/"
            }
            const d = { BASE_URL: r, API_BASE_URL: o, PDB_CLIENT: l, AKWAABA_API_BASE_URL: n, FILE_BUCKET_BASE_URL: a, HOME_PAGE_BASE_URL: i, PUBLIC_PAGE_BASE_URL: p, LOGIN_PAGE_BASE_URL: void 0, PUBLIC_LOGIN_PAGE_BASE_URL: void 0, PUBLIC_BASE_URL: "https://akwaabaapp.com/", CLICK_COM_BASE_URL: "https://clickcomgh.com/" }
        },
        7052: (e, t, s) => {
            s.r(t), s.d(t, { base64Encode: () => o, base64Decode: () => n });
            var r = s(8764);
            const o = (e, t = !1) => { const s = r.Buffer.from(e).toString("base64"); return t ? s.replaceAll("=", "") : s },
                n = e => r.Buffer.from(e, "base64").toString()
        },
        1942: (e, t, s) => {
            function r(e, t, s = 1, r = "/") {
                let o = new Date;
