                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php
                                                    ...
                                                    <?php }
                                                ?>
                                                <a href="<?= CLIENT_BASE_URL; ?>logout" type="button" tabindex="0" class="dropdown-item <?= ($url_endpoint == "logout") ? "active": ""; ?>">Logout</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="widget-content-left  ml-3 header-user-info">
                                        <div class="widget-heading">
                                            <?= $user_info['pdcu_firstname'] . " " . $user_info['pdcu_surname']; ?> 
                                        </div>
