...
<li>
    <a href="#" class="text-primary" 
        mm-active="view-groups|create-groups">
        <i class="metismenu-icon pe-7s-note2"></i><i class="pe-7s-users"></i> Groups
        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
    </a>
    <ul>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/group/view-groups" mm-active="view-groups">
                <i class="metismenu-icon"></i> View Groups
            </a>
        </li>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/group/create-groups" mm-active="create-groups">
...
<li>
    ...
    <ul>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/bulk-assignment/group/view-g-list" mm-active="view-g-list">
                <i class="metismenu-icon"></i> View Group
            </a>
        </li>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/bulk-assignment/group/assign-g-list" mm-active="assign-g-list">
...
<li>
    <a href="#" class="text-primary" 
        ...
        <i class="metismenu-icon pe-7s-note2"></i><i class="pe-7s-users"></i> Sub-Groups
        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
    </a>
    <ul>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/subgroup/view-sub-groups" mm-active="view-sub-groups">
                <i class="metismenu-icon"></i> View Sub-Groups
            </a>
        </li>
        <li>
...
<li>
    ...
    <ul>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/bulk-assignment/subgroup/view-sg-list" mm-active="view-sg-list">
                <i class="metismenu-icon"></i> View Sub-Group
            </a>
        </li>
        <li>
            <a href="<?= CLIENT_BASE_URL; ?>groupings/bulk-assignment/subgroup/assign-sg-list" mm-active="assign-sg-list">
