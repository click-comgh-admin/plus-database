<?php
	...
	// 	function __construct($base_url, $location_base_url)
	// 	{
	// 		$this->base_url = $base_url;
	// 		$this->location_base_url = $location_base_url;
	// 	}

	// 	public function account_type($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function subscription_duration($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function subscription_fee($duration_id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function membership_size($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function designation($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all) {
	...
	// 	public function occupation($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function client_levels($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function education($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function marital_status($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function active_status($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function religion($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function languages($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function account_code($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function account_code_post($update=false, $post, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($update === true) {
	...
	// 	public function account_sms_id($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function account_sms_id_post($update=false, $post, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($update === true) {
	...
	// 	public function forgot_password($type = "member", $email, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($type === "member") {
	...
	// 	public function reset_password($type = "client", $post, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($type === "member") {
	...
	// 	public function account_login($type = "client", $post, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($type === "member") {
	...
	// 	public function user_info($type = "client", $account_id, $all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($type === "member") {
	// 			if ($all === true) {
	...
	// 	public function client_status($all=false, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function get_location($type="regions", $get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function groups($all=false, $account_id, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function subgroups($all=false, $account_id, $group_id = null, $id=1, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	// 		if ($all === true) {
	...
	// 	public function client_members($type="members", $get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function action_post($url, $post, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function communications($type="clients", $get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function message_types_alt($endpoint, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function file_manager($get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function attendance($get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function dues($get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function school($get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
	...
	// 	public function custom_form($get_string, $callback, $debug = false)
	// 	{
	// 		$curl = curl_init();
