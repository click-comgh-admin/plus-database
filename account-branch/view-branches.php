<?php
    ...
    define('PAGE_TITLE', "Branch(es) => View Branch(es)");
    define('PAGE_DESC', "View Branch(es)");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-share icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        ?>
                        <?php
                            require_once('subpages/view.php');
                        ?>
                    </div>
