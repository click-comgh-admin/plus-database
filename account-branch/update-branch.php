<?php
    ...
    define('PAGE_TITLE', "Branch(es) => View Branch User");
    define('PAGE_DESC', "View Branch User");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-albums icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."account-branch/");
                            define("Current_BaseDir", BASE_DIRECTORY."/account-branch/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/edit.php');
                        ?>
                    </div>
