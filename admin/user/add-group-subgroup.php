<?php
    ...
    define('PAGE_DESC', "Add User Account");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'admin/user/add_group_subgroup', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-admin-user-add-group-subgroup-form></pdb-admin-user-add-group-subgroup-form>
                                    </div>
                                </div>
                            </div>
                        </div>
