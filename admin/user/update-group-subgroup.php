<?php
    ...
    define('PAGE_DESC', "Update User Account");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'admin/user/edit_group_subgroup', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            foreach ($appPages as $key => $page) {
                                if ((string)strtolower($page['pdpc_page']) === "account users") {
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-admin-user-edit-group-subgroup-form page_type="mine"></pdb-admin-user-edit-group-subgroup-form>
                                    </div>
                                </div>
                            </div>
                        </div>
