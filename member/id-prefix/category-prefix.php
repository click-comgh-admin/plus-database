<?php
    ...
    define('PAGE_TITLE', "Member Identifications -> Category Prefix");
    define('PAGE_DESC', "View Category ID Prefix");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/id-prefix/category-prefix', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <id-category-prefix></id-category-prefix>
                                    </div>
                                </div>
                            </div>
                        </div>
