<?php
    ...
    define('PAGE_TITLE', "Members -> Connections -> Accounts");
    define('PAGE_DESC', "View/ Create Connection Accounts");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/connections/accounts', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-connections-accounts></pdb-connections-accounts>
                                    </div>
                                </div>
                            </div>
                        </div>
