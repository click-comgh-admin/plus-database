<?php
    ...
    define('PAGE_DESC', "View Connection Members");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/connections/connection', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-connections-connections></pdb-connections-connections>
                                    </div>
                                </div>
                            </div>
                        </div>
