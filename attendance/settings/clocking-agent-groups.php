<?php
    ...
    define('PAGE_TITLE', "Mobile App Admin(s) => Admin Assigned Groups");
    define('PAGE_DESC', "Admin Assigned Groups");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/clocking-Admin/groups_subgroups/group/view.php');
                        ?>
                    </div>
