                    ...
                    if ((bool)$this->assign_group === true) { ?>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <?php
                                    $get_string = "communications/clients/clocking/access-code?account_id=" . AccountInfoId . "&user=" . $this->user_id;
                                    ...
                                    if ((bool)MyAppAccess['unlimited'] === true) {
                                        $get_string = "communications/clients/clocking/groups?account_id=" . AccountInfoId;
                                        $groups = $ccApi->fetch_from($get_string=$get_string, function($access_code) {
                                            return $access_code;
                                        }, $debug=false);
                                    } else {
                                        $get_string = "communications/clients/clocking/group?account_id=" . AccountInfoId . "&code=" . $access_code;
                                        $groups = $ccApi->fetch_from($get_string=$get_string, function($access_code) {
                                            return $access_code;
                                        }, $debug=false);
                                    }
