<?php
    namespace ClockingAgentsAssignGroup;

    use ClickComApi;
    use TemplateFile\TemplateFile;

    class ClockingAgentsAssignGroup
    {
        public $data = [];
        public $user_id;
        public $encryptor;
        ...
        { ?>
            <div class="col-lg-8 col-md-8">
                ...
                <div class="row justify-content-center">
                    <?= $this->header("Select Agent to Assign to Group."); ?>
                    <div class="col-lg-12 col-md-12">
                        <?php
                            $tittle_placeholder = "Select Agent to Assign to Group";
                            $id_name = "agent_id";
                        ?>
