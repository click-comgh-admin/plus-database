<?php
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['add-form']) && $_POST['add-form'] == "attendancevisibility_info") {
            define("POST_URL", API_BASE_URL."attendance/clients/clocking/visibility");
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    ...
                    <?php
                        ...
                        $input_value = (isset($visibility['pdad_is_visible'])) ? $visibility['pdad_is_visible']: $input_value;
