<?php
    ...
    define('PAGE_TITLE', "Mobile App Admin(s) => Admin Assigned Sub-Groups");
    define('PAGE_DESC', "Admin Assigned Sub-Groups");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/clocking-Admin/groups_subgroups/subgroup/view.php');
                        ?>
                    </div>
