<?php
    ...
    define('PAGE_TITLE', "Mobile App Admin(s) => Admins Assigned Group");
    define('PAGE_DESC', "Admins Assigned Group");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/clocking-agent/groups_subgroups/group/view-agents.php');
                        ?>
                    </div>
