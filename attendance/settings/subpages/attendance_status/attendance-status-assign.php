        ...
        <div class="mb-3 card shadow">
            <div class="card-body">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <?php
                            require_once Current_BaseDir."/forms/attendance_status/new-assign.php";
        ...
        <div class="mb-3 card shadow">
            <div class="card-body">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <?php
                            require_once Current_BaseDir."/forms/attendance_status/filter-assign.php";
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="user-attendance-status" pt_c_acc_id="<?= AccountInfoId; ?>"
