...
<?php 
    if (isset($_GET['agent']) && !empty($_GET["agent"])) {
        ...
        $get_string = "communications/clients/clocking/clocking-agent?account_id=" . AccountInfoId."&member_id=$_user_id";
        ...
        <?php } else {
            if (isset($_GET['group']) && !empty($_GET["group"])) {
                $get_string = "communications/clients/clocking/group?account_id=" . AccountInfoId . "&id=" . $_GET["group"];
                ...
                <?php } else {
                    if (isset($thisGroup['pdccc_id'])) {
                        $get_string = "communications/clients/clocking/clocking-agent-group?account_id=" . AccountInfoId.
                        ...
                        <?php } else {
                            require_once Current_BaseDir."/subpages/clocking-agent/agent_clockings.php"; 
                        }
                    } else { ?>
