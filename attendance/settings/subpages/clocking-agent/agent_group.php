        ...
        <div class="mb-3 card shadow">
            <div class="card-body">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <?php
                            require_once Current_BaseDir."/forms/clocking-agent/assign_groups.php";
                        ?>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                ?>
                <h5 class="card-title">Mobile App Admin [ <i><b><?= $member_info['pdm_firstname']. " " .$member_info['pdm_surname']; ?></b></i> ] Group(s)</h5>
                                ...
                                foreach ($agent_groups as $key => $agent_group) { ?>
                                    <tr>
                                        <td style="white-space: nowrap;">
                                            <?php
                                                $get_string = "communications/clients/clocking/group?account_id=" . AccountInfoId . "&id=" . $agent_group['pdccag_group_id'];
                                        ...
                                        <td>
                                            <?php
                                                $get_string = "communications/clients/clocking/clocking-agent-clockings?account_id=" . AccountInfoId."&agent_id=".$agent['pdcca_id']."&group_id=".$agent_group['pdccag_group_id'];
                                                $group_clockings = $ccApi->fetch_from($get_string = $get_string, function ($group_clockings)
                                                {
                                                    return isset($group_clockings[0])? $group_clockings: [];
                                                }, $debug = false);
                                            ...
                                            <div class="shadow shadow-lg m-1 d-block d-inline-block p-1 px-3 bg-white font-weight-bold rounded text-dark text-center">
                                                <?= count($group_clockings); ?> 
                                                <a href="<?= Current_BaseUrl; ?>clocking-agent-clockings?agent=<?= $_user_id_; ?>&group=<?= $agent_group['pdccag_group_id']; ?>" 
                                        ...
                                        <td styl e="white-space: nowrap;">
                                            ...
                                            <button type="button" class="btn btn-sm m-1 btn-danger shadow"
                                                ...
                                                btn-submit-post--confirm="Remove Admin Group?"
                                                btn-submit-post--url="<?= API_BASE_URL."communications/clients/clockings/clocking/delete-clocking-agent-group"; ?>">
