        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                <h5 class="card-title">
                    ...
                    Group ( <i><b><?= $thisGroup['pdccc_name']; ?></b></i> ) Clocking
                </h5>
                <form role="form" action="<?= API_BASE_URL."communications/clients/clockings/groups/delete-clocking"; ?>" method="POST"
                    make-general-posts="Delete Selected Clockings?" >
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" pagin_table="agent-group-clockings-admin" pt_c_id="<?= $account_id; ?>"
