    ...
    if (isset($_GET['agent']) && !empty($_GET["agent"])) {
        ...
        <?php } else {
            if (isset($agent['pdcca_id'])) {
                $get_string = "communications/clients/clocking/clocking-agent-groups?account_id=" . AccountInfoId."&agent_id=".$agent['pdcca_id'];
            ...
            require_once Current_BaseDir."/subpages/clocking-agent/agent_group.php"; 
        }
    } else { ?>
