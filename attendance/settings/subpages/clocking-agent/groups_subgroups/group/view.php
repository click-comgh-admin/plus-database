<?php
    ...
    $pageUrl = CLIENT_BASE_URL . "attendance/settings/clocking-agent-groups?agent-id=$agentId";
    $viewType = 1;
                    ...
                    <div class="col-md-10 col-lg-10">
                        ...
                        <?php
                            if ($agentId === 0) {
                                ...
                                require_once Current_BaseDir."/forms/clocking-agent/groups/new.php";
                            }
                        ?>
                    </div>
                </div>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                <h5 class="card-title">Mobile App Admin Group Assignments</h5>
                <div class="table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="clocking-agent-assignments"
                        pt_c_id="<?= AccountInfoId; ?>" pt_c_user="<?= $user_id; ?>" pt_c_table-type="clocking-agent-groups"
