<?php
    ...
    define('PAGE_TITLE', "Mobile App Admin(s) => Admins Assigned Sub-Group");
    define('PAGE_DESC', "Admins Assigned Sub-Group");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-clock icon-gradient bg-happy-fisher">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."attendance/settings/");
                            define("Current_BaseDir", BASE_DIRECTORY."/attendance/settings/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/clocking-agent/groups_subgroups/subgroup/view-agents.php');
                        ?>
                    </div>
