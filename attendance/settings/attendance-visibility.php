<?php
    ...
    define('PAGE_DESC', "Setup Public Visibility");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            // require_once('subpages/attendance_visibility.php');
                            require_once('subpages/attendance-visibility/attendance_visibility.php');
                        ?>
                    </div>
