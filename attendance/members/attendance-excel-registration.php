<?php
    ...
    define('PAGE_TITLE', "Attendance => Registration");
    define('PAGE_DESC', "Clocking Member Excel Registration");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="fa fa-file-excel icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."attendance/members/");
                            define("Current_BaseDir", BASE_DIRECTORY."/attendance/members/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/attendance-excel-registration/view.php');
                        ?>
                    </div>
