<?php
    if (isset($_POST) && !empty($_POST) && isset($_POST['create'])) {
        define("POST_URL", API_BASE_URL."attendance/clients/members/group/add");
        require_once 'group-create_form - processing.php';
    }
?>
<form role="form" action="<?= Current_BaseUrl; ?>attendance-group?<?= $_SERVER['QUERY_STRING']; ?>" method="POST">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Create New Group";
				$id_name = "group";
			?>
			<h6></h6>
            <?php
