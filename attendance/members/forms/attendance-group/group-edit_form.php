<form role="form" action="<?= API_BASE_URL."attendance/clients/members/group/edit"; ?>" method="POST"
    make-general-posts="<?= $confirm_msg; ?> (<?= $group_name; ?> ? <?= $type; ?>)">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Edit Group";
				$id_name = "group";
			?>
            <h6></h6>
            <?php
                $input_value = 'value="'.$group_name.'"';
