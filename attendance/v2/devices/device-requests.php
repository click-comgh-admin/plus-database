<?php
    ...
    define('PAGE_TITLE', "Attendance V2 => Clocking Device");
    define('PAGE_DESC', "View Scheduled Clocking Device(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/devices/requests', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <attendance-device-requests CLIENT_ID="<?= $user_info['pdcu_account_id']; ?>">
