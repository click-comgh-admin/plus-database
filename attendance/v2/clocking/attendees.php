<?php
    ...
    define('PAGE_DESC', "Meeting/ Event(s) Attendance");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/clocking/attendees', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-attendance-clocking-attendees></pdb-attendance-clocking-attendees>
                                    </div>
                                </div>
                            </div>
                        </div>
