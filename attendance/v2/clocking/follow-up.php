<?php
    ...
    define('PAGE_DESC', "Attendance Follow-Up");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/clocking/follow_up', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-attendance-clocking-follow_up></pdb-attendance-clocking-follow_up>
                                    </div>
                                </div>
                            </div>
                        </div>
