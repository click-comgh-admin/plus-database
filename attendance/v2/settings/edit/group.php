<?php
    ...
    define('PAGE_DESC', "Update Schedule Meeting/ Event Group");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/setup-form/edit-group', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <attendance-setup-form-edit-group email="<?= $user_info['pdcu_email']; ?>" 
