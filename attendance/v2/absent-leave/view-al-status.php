<?php
    ...
    define('PAGE_TITLE', "Absent/ Leave -> View Status");
    define('PAGE_DESC', "View Status");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/absent-leave/status/view', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <attendance-absent-leave-status-view email="<?= $user_info['pdcu_email']; ?>" 
