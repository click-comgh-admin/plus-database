<?php
    ...
    define('PAGE_TITLE', "Absent/ Leave -> View Assignment");
    define('PAGE_DESC', "View Assignment");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'attendance/absent-leave/assignment/view', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <attendance-absent-leave-assignment-view email="<?= $user_info['pdcu_email']; ?>" 
