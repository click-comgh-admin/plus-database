<?php
    ...
    define('PAGE_TITLE', "Attendance => Attendees");
    define('PAGE_DESC', "Attendees");
?>
<!doctype html>
<html lang="en">
                            ...
                            if (isset($_GET['group'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendees" class="card btn btn-block mb-3 widget-content bg-sunny-morning">
                                    ...
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendees?subgroup" class="card btn btn-block mb-3 widget-content bg-arielle-smile">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/attendees/attendees_groups.php');
                            } else if (isset($_GET['subgroup'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendees?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/attendees/attendees_subgroups.php');
                            } else { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendees?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                ...
                                <?php require_once('subpages/attendees/attendees.php');
                            }
                        ?>
                    </div>
