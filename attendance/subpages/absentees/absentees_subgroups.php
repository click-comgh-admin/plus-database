    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <?php
                ...
                $page_url = "attendance/absentees?subgroup&gender=".@$_GET['gender']."&status=".@$_GET['status'] . "&subgroup_id=$subgroup_id";
                $page_reset = "attendance/absentees?subgroup";
                $isYear = false;
            ?>
            <div class="card-header-tab card-header-tab-animation card-header h-25">
                <div class="card-header-title">
                    <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"> </i> Absentees => Sub-Groups
                </div>                
