    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <?php
                ...
                $page_url = "attendance/absentees?group&gender=".@$_GET['gender']."&status=".@$_GET['status'] . "&group_id=$group_id";
                $page_reset = "attendance/absentees?group";
                $isYear = false;
            ?>
            <div class="card-header-tab card-header-tab-animation card-header h-25">
                <div class="card-header-title">
                    <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"> </i> Absentees => Groups
                </div>              
