    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <?php
                ...
                $page_url = "attendance/attendance-records?gender=".@$_GET['gender']."&status=".@$_GET['status'];
                $page_reset = "attendance/attendance-records";
                $isYear = true;
            ...
            <div class="card-header-tab card-header-tab-animation card-header h-25">
                <div class="card-header-title">
                    <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"> </i> Records
                </div>
                <div class="btn-actions-pane-right">
                    <?php require_once(BASE_DIRECTORY.'/subpages/membership/forms/quarter_filter_form.php'); ?>
            ...
            <div class="card-body">
                ...
                <div>
                    <?php
                        ...
                        $get_date = (isset($_COOKIE['date_filter_input'])) ? date("Y-m-d", strtotime($_COOKIE['date_filter_input']."/1/1")): date("Y-m-d");
