    ...
    <div class="col-md-12 col-lg-12">
        <div class="main-card mb-3 card shadow">
            <?php
                ...
                $page_url = "attendance/attendance-records?subgroup&gender=".@$_GET['gender']."&status=".@$_GET['status'] . "&subgroup_id=$subgroup_id";
                $page_reset = "attendance/attendance-records?subgroup";
                $isYear = true;
            ...
            <div class="card-header-tab card-header-tab-animation card-header h-25">
                <div class="card-header-title">
                    <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"> </i> Records => Sub-Groups
                </div>                
                <div class="btn-actions-pane-right">
                    <?php require_once(BASE_DIRECTORY.'/subpages/membership/forms/quarter_subgroup_filter_form.php'); ?>
