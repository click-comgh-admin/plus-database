<?php
    ...
    define('PAGE_TITLE', "Meetings => Web Approvals");
    define('PAGE_DESC', "Approve Web Clocking");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class=" pe-7s-plug icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."attendance/clocking/");
                            define("Current_BaseDir", BASE_DIRECTORY."/attendance/clocking/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/web-approvals-meeting/view.php');
                        ?>
                    </div>
