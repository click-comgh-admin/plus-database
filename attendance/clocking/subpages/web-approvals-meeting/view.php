<?php
    ...
    if (isset($_GET['display'])) {
        ...
        $url = "$page?$newQueryString";
        $btnTitle = "Show Today's Approvals";
    } else {
        $url = "$page?$newQueryString&display=all-approvals";
        $btnTitle = "Show All Approvals";
    }
