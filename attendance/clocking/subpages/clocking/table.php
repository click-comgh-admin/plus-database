    ...
    <div class="card-body mb-2 container">
        <div class="row">
            ...
            <div class="collapse show p-0 col-md-6" id="clock_in_out_time">
                ...
                <i>
                    <?php require_once Current_BaseDir."/forms/clocking/time_select_form.php"; ?>
                </i>
            </div>
        </div>
    </div>
...
<div class="w-100">
    <form role="form" action="" method="POST"
        ...
        <table class="mb-0 table table-striped table-hover w-auto" pagin_table="attendance-clocking" pt_c_acc_id="<?= AccountInfoId; ?>"
