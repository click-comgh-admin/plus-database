<div class="w-100">
    <form role="form" action="" method="POST"
        ...
        <table class="mb-0 table table-striped" pagin_table="attendance-approvals_all" pt_c_acc_id="<?= AccountInfoId; ?>"
            pt_c_by_date="0" pt_c_selected_date="<?= $selected_date; ?>" pt_c_by_group_id="<?= $by_group_id; ?>" 
