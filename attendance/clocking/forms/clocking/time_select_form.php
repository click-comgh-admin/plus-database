    ...
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-6">
            ...
            <?php
                ...
                // $input_value = @(is_null($input_value)) ? $clockintime : date("H:i", strtotime(@$input_value));
        ...
        <div class="col-lg-6">
			...
			<h6><?= $tittle_placeholder; ?></h6>
            <?php
                $input_value = $expectedOutTime;
                $input_value = @(isset($_GET[$id_name])) ? $_GET[$id_name] : $input_value;
                $clockouttime = $input_value;

                $input_value = @(is_null($input_value)) ? $end_time : date("H:i", strtotime(@$input_value));
                // $input_value = @(is_null($input_value)) ? $clockouttime : date("H:i", strtotime(@$input_value));
                $input_value = 'value="'.$input_value.'"';
