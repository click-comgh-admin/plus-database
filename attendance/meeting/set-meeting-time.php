<?php
    ...
    define('PAGE_TITLE', "Attendance => Meeting Info");
    define('PAGE_DESC', "Information about Meeting");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-coffee icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."attendance/meeting/");
                            define("Current_BaseDir", BASE_DIRECTORY."/attendance/meeting/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/set-meeting-time/view.php');
                        ?>
                    </div>
