<?php
    ...
    define('PAGE_TITLE', "Attendance => Records");
    define('PAGE_DESC', "View Member's Attendance Records");
?>
<!doctype html>
<html lang="en">
                            ...
                            if (isset($_GET['group'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-records" class="card btn btn-block mb-3 widget-content bg-sunny-morning">
                                    ...
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-records?subgroup" class="card btn btn-block mb-3 widget-content bg-arielle-smile">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/records/records_groups.php');
                            } else if (isset($_GET['subgroup'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-records?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/records/records_subgroups.php');
                            } else { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-records?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                ...
                                <?php require_once('subpages/records/records.php');
                            }
                        ?>
                    </div>
