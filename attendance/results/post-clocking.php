<?php
    ...
    define('PAGE_TITLE', "Attendance => Results");
    define('PAGE_DESC', "Post Clocking");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class=" pe-7s-timer icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        ?>
                        <?php
                            require_once('subpages/post-clocking/view.php');
                        ?>
                    </div>
