            ...
            <div class="card-body">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <?php require_once Current_BaseDir."/forms/attendee_absentees/date_filter_form.php";?>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <?php require_once Current_BaseDir."/forms/attendee_absentees/other_filter_form_alt.php"; ?>
                    </div>
                    <div class="col-md-12 col-lg-12"></div>
                </div>
            </div>
        ...
        <div class="main-card mb-3 card shadow">
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <div class="fa pull-right customTooltip">
                    ...
                    ?>
                    <button click-to-copy="attendees-url" type="button" class="btn btn-outline-info">
                        <span class="customTooltiptext">Copy Attendees URL to clipboard</span>
                        <input type="text" value="<?= str_replace("results", "public", $page_url).$addParams; ?>" />
                        Copy Attendees URL to clipboard
                    </button>
                </div>
            </div>
        </div>
