<form class="container" role="form" action="<?= $page_url . "?" . $_SERVER['QUERY_STRING']; ?>" method="GET">
    <div class="row align-items-center justify-content-center">
        ...
        <input type="hidden" name="subgroup" value="view" />
        <div class="col-lg-12">
            <?php 
            ...
            <?php
                $set_subgroup = @(isset($_COOKIE[$id_name])) ? $_COOKIE[$id_name] : "all";
                $set_subgroup = (isset($_GET[$id_name])) ? $_GET[$id_name] : $set_subgroup;
        ...
        <div class="col-lg-6">
            <?php
                ...
                $subgroupQuery = ($set_subgroup === "all")? "": "&subgroup_id=".$set_subgroup;
                $genderQuery = ($_input_value === "all")? "": "&gender=".$_input_value;
                $get_string = "membership-filter/subgroups?currentpage=1&rowsperpage=100000&client_id=".AccountInfoId.$subgroupQuery.$genderQuery;
            ...
            <?php
                ...
                ';
                $rowsperpage = 10000;
                $get_url = API_BASE_URL."/membership-filter/subgroups?currentpage=1&rowsperpage=$rowsperpage&client_id=" . AccountInfoId;
                $input_attributes = 'name="'.@$id_name.'" id="'.@$id_name.'" filterForms-ids="subgroup_id,gender"
