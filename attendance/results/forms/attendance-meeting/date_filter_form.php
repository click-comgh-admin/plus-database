    ...
    <div class="row align-items-center justify-content-center">
        ...
        <?php
            if (isset($_GET['meeting_id'])) { 
                $dateFilterFormMeetingID = (int)$_GET['meeting_id']; ?>
                <input type="hidden" name="meeting_id" value="<?= $dateFilterFormMeetingID; ?>" />
            <?php } else {
                $dateFilterFormMeetingID = 0;
            }
        ?>
        <div class="col-lg-6">
			<?php 
        ...
        <div class="col-lg-6 text-center">
            <a type="button" href="<?= $page_url . "?" . $_SERVER['QUERY_STRING']."&start_date=".$fiveDaysBefore."&meeting_id=$dateFilterFormMeetingID"; ?>"
                class="btn btn-sm bg-midnight-bloom text-light text-white font-weight-bold m-1">Reset Start Date</a>
            <a type="button" href="<?= $page_url . "?" . $_SERVER['QUERY_STRING']."&end_date=".$today."&meeting_id=$dateFilterFormMeetingID"; ?>"
