<?php
    ...
    define('PAGE_TITLE', "Attendance => Clocking");
    define('PAGE_DESC', "Mark Members Present");
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-check icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                            ...
                            if (isset($_GET['group'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-clocking" class="card btn btn-block mb-3 widget-content bg-sunny-morning">
                                    ...
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-clocking?subgroup" class="card btn btn-block mb-3 widget-content bg-arielle-smile">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/clocking/clocking_groups.php');
                            } else if (isset($_GET['subgroup'])) { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-clocking?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                ...
                                <?php require_once('subpages/clocking/clocking_subgroups.php');
                            } else { ?>
                                <div class="row">
                                    <div class="col-md-6 col-xl-6">
                                        <a href="<?= Attendance_BaseUrl; ?>attendance-clocking?group" class="card btn btn-block mb-3 widget-content bg-midnight-bloom">
                                ...
                                <?php require_once('subpages/clocking/clocking.php');
                            }
                        ?>
                    </div>
