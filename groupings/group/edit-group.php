<?php
    ...
    define('PAGE_DESC', "Edit Group");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/group_subgroup/groups/edit', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-groupings-group_subgroup-group-edit email="<?= $user_info['pdcu_email']; ?>" 
                                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                                        </membership-groupings-group_subgroup-group-edit>
                                    </div>
                                </div>
                            </div>
                        </div>
