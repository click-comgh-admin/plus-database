<?php
    ...
    define('PAGE_DESC', "Assign Group(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/bulk_assignment/groups/add', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-groupings-bulk_assignment-groups-add email="<?= $user_info['pdcu_email']; ?>" 
