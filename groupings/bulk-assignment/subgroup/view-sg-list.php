<?php
    ...
    define('PAGE_TITLE', "Bulk Assignment -> Sub-Group(s)");
    define('PAGE_DESC', "View Assigned Sub-Group(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/bulk_assignment/subgroups', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-groupings-bulk_assignment-subgroups-view email="<?= $user_info['pdcu_email']; ?>" 
                                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                                        </membership-groupings-bulk_assignment-subgroups-view>
                                    </div>
                                </div>
                            </div>
                        </div>
