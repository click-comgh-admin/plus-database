<?php
    ...
    define('PAGE_TITLE', "Groupings -> Memeber Category");
    define('PAGE_DESC', "View Memeber Category");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/member_categories/one', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-registration-excel-create email="<?= $user_info['pdcu_email']; ?>" 
                                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                                        </membership-registration-excel-create>
                                    </div>
                                </div>
                            </div>
                        </div>
