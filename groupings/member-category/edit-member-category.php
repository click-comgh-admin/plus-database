<?php
    ...
    define('PAGE_TITLE', "Groupings -> Member Category");
    define('PAGE_DESC', "Edit Member Category");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/member_categories/edit', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-groupings-member-categories-edit email="<?= $user_info['pdcu_email']; ?>" 
                                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                                        </membership-groupings-member-categories-edit>
                                    </div>
                                </div>
                            </div>
                        </div>
