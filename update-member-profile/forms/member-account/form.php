        ...
        public function main_content($tf, $ccApi)
        {
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-6 col-lg-8">
                    ...
                    <h6><?= $titlePlaceholder; ?></h6>
                    <?php
                        $input_value = (isset($appProfile['businessDesc'])) 
                            ? ($appProfile['businessDesc']) : "";
                ...
                <?php
                    ...
                    foreach ($this->additionalQuestions as $key => $question) {
                        if (isset($question['question'])) {
                            $formId = $question['form']['id'];
                            $additionalQuestion = $question['question'];
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <?php 
                                        ...
                                        $customForms2->setFileUploaderPageUrlParams(
                                            $memberId, $memberResponseId, $formId, $additionalQuestionId
                                        );
